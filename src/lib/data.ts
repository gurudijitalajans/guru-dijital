...
export const services: Service[] = [
  {
    ...
    images: [
      ...
      { src: "/work/instagram-postlar.webp", alt: "Instagram gönderi tasarımları kolajı" },
    ],
  ...
  },
  {
    ...
    icon: Palette,
    intro: [
      "Görsel tasarım, markanızın dış dünyaya attığı ilk adımdır — ve bu adım, doğru atıldığında güçlü bir etki yaratır. Markanızın kimliğini yansıtan özgün ve yaratıcı tasarımlar üreterek mesajınızı hedef kitlenize estetik ve stratejik bir bütünlük içinde ulaştırıyoruz.",
  ...
  },
  {
    ...
    images: [
      { src: "/work/icerik-uretimi.webp", alt: "İçerik üretimi kreatif tasarım" },
      { src: "/work/sosyal-icerik-cita.webp", alt: "Sosyal medya kreatif içerik tasarımı" },
    ],
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/work/instagram-postlar.webp", alt: "Sosyal medya içerik tasarımları" },
    ],
...
export const products: Product[] = [
  ...
  },
  {
    ...
    image: "/work/instagram-postlar.webp",
